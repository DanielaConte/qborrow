				...
				<tr ng-repeat="row in scopeController.result.list">
					...
					<td class="qtext-right">
						<div class="qbtn-group" ng-hide="popup">
		                  	...
		                  	<button class="qbtn btn-framework-color" ng-click="edit(row)" ng-if="row.oggettoPrestato" type="button"><i class="fa fa-plus"></i>&nbsp;<s:text name="button.newPrestito" /></button>
