...
<form name="forms.oggettiEditForm" novalidate>
		...
		<div class="box-body">
			<div class="qrow">		
				<div class="qcol-md-6 qcol-sm-6 qcol-xs-12" ng-class="{'qhas-error': forms.oggettiEditForm.id.$invalid}">
					...
					<div ng-messages="forms.oggettiEditForm.id.$error" role="alert">
				...
				<div class="qcol-md-6 qcol-sm-6 qcol-xs-12" ng-class="{'qhas-error': forms.oggettiEditForm.soggetti.$invalid}">
					...
					<span class="quix-popup-search-field">      
		              	<div class="quix-popup-search-field-container">
			              	<div>
			              		<div class="quix-popup-search-field-label">{{scopeController.selectedRow.soggetti_description}}</div>
			             		<div class="quix-popup-search-field-icon">
									<i class="fa fa-times fa-lg" ng-click="qxResetPopupField(scopeController.selectedRow, 'soggetti')"></i>
			             		</div>
			             		<div class="quix-popup-search-field-icon">
									<i class="fa fa-search fa-lg" ng-click="openPopupField('Soggetti', scopeController.selectedRow, 'soggetti', 'username', 'username')"></i>
			             		</div>
			             	</div>
		              	</div>  
		           </span>
